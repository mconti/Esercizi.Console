...
$classe_obj = @{
    ...
    PATH_ESERCIZI = "$ROOT_ESERCIZI/4H-Informatica/Esercizi/Zip"

    # Path alla cartella con tutti i risultati
    PATH_RISULTATI = "$ROOT_ESERCIZI/4H-Informatica/Esercizi/Risultati"

    # Elenco alunni
    #ALUNNI = @( "Lombardi.Giacomo", "Marazzi.Kevin", "Alessandri.Giacomo", "Dhamo.Aleksander", "Giorgetti.Alessio", "Goci.Erdi", "Cecchetti.Mattia")
    #ALUNNI = @("Cecchetti.Mattia", "Mingrone.Lorenzo", "Lombardi.Giacomo")

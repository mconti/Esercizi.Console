...
public class HighScoresTest
{
    ...
    {
        var sut = new HighScores(new int[] { 30, 50, 20, 70 });
        Assert.Equal(new int[] { 30, 50, 20, 70 }, sut.Scores());
    }

    [Fact]
    public void Latest_score()
    {
        var sut = new HighScores(new int[] { 100, 0, 90, 30 });
    ...
    {
        var sut = new HighScores(new int[] { 40, 100, 70 });
    ...
    {
        var sut = new HighScores(new int[] { 10, 30, 90, 30, 100, 20, 10, 0, 30, 40, 40, 70, 70 });
    ...
    {
        var sut = new HighScores(new int[] { 20, 10, 30 });
    ...
    {
        var sut = new HighScores(new int[] { 40, 20, 40, 30 });
    ...
    {
        var sut = new HighScores(new int[] { 30, 70 });
    ...
    {
        var sut = new HighScores(new int[] { 40 });
